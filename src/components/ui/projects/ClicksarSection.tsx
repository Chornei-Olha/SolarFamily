    ...
    >
      <div className="flex flex-col gap-12 items-center text-white">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h2 className="text-3xl md:text-4xl font-bold">«Кліксар»</h2>
          <p className="leading-relaxed">
            Проєкт реалізовано у форматі «під ключ» – від проєктування та постачання обладнання до
            монтажу і запуску.
          </p>

          <h3 className="text-2xl font-semibold">Про компанію «Кліксар»</h3>
          <p>
            Кліксар — український виробник пластикової тари та пакувальних рішень для харчової,
            аграрної та промислової галузей. Підприємство працює понад 20 років, постачаючи
            продукцію на внутрішній і зовнішній ринки.
          </p>
          <p>
            Компанія поєднує сучасні технології, високі стандарти якості та орієнтацію на
            екологічність, приділяючи особливу увагу зменшенню впливу виробництва на довкілля.
          </p>

          <h3 className="text-2xl font-semibold">Енергетичне рішення для виробництва</h3>
          <p>
            Виробництво пластикової тари є енергоємним процесом: робота термопластавтоматів, систем
            охолодження, освітлення та вентиляції потребує значних ресурсів. Встановлення сонячної
            електростанції дозволило «Кліксар» скоротити витрати на електроенергію, підвищити
            стабільність роботи та зменшити залежність від коливань тарифів.
          </p>

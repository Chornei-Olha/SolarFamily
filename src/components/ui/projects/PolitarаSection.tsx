    ...
    >
      <div className="flex flex-col gap-12 items-center text-white">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h2 className="text-3xl md:text-4xl font-bold ">«Політара»</h2>
          <p className="leading-relaxed">
            Проєкт реалізовано у форматі «під ключ» – від проєктування та постачання обладнання до
            монтажу і запуску.
          </p>

          <h3 className="text-2xl font-semibold">Про компанію «Політара»</h3>
          <p>
            «Політара» — українське підприємство, що спеціалізується на виробництві полімерної тари
            та пакувальних рішень для харчової, хімічної та аграрної промисловості. Компанія працює
            на ринку понад 20 років, забезпечуючи клієнтів якісною та надійною продукцією, яка
            відповідає сучасним стандартам.
          </p>
          <p>
            «Політара» постійно інвестує у модернізацію виробництва та впровадження інноваційних
            технологій, роблячи акцент на енергоефективності та екологічності.
          </p>

          <h3 className="text-2xl font-semibold">Енергетичне рішення для виробництва</h3>
          <p>
            Виробництво полімерної тари є енергоємним процесом: робота термопластавтоматів, систем
            охолодження та вентиляції потребує стабільного енергопостачання. Встановлення сонячної
            електростанції дозволяє «Політара» знизити витрати на електроенергію, забезпечити
            безперебійну роботу та зменшити залежність від коливань тарифів.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="bg-white text-black p-6 space-y-3">
              ...
              <ul className="list-disc list-inside">
                <li>Потужність: 181,72 кВт</li>
                <li>Тип системи: мережева (on-grid)</li>
                <li>Обладнання: фотомодулі Longi та інвертори Huawei</li>
                <li>Локація: виробничий комплекс «Політара»</li>
                <li>Формат реалізації: повний цикл «під ключ»</li>
              </ul>
            </div>
            <div className="bg-white text-black p-6 space-y-3">
              <h4 className="text-lg font-semibold">Переваги для «Політара»:</h4>
              <ul className="list-disc list-inside">
                <li>Суттєве зниження витрат на електроенергію</li>
                <li>Стабільність енергопостачання виробничих процесів</li>
                <li>Підвищення енергонезалежності підприємства</li>
                <li>Підтримка принципів екологічності та сталого розвитку</li>
                <li>Формування іміджу сучасного й інноваційного виробника пакувальної продукції</li>
              </ul>
            </div>
          </div>
        </motion.div>

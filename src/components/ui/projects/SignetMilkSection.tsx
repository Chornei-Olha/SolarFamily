...
export default function SignetMilkSection() {
    ...
    >
      <div className="flex flex-col gap-12 items-center text-white">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h2 className="text-3xl md:text-4xl font-bold ">«Сігнет-Мілк»</h2>
          <p className="leading-relaxed">
            Проєкт реалізовано у форматі «під ключ» – від проєктування та постачання обладнання до
            монтажу і запуску.
          </p>

          <h3 className="text-2xl font-semibold">Про компанію «Сігнет-Мілк»</h3>
          <p>
            «Сігнет-Мілк» — одне з найбільших молочно-товарних підприємств в Україні, що входить до
            агропромислової групи «Сігнет Холдинг». Компанія спеціалізується на виробництві
            високоякісного молока, використовуючи сучасні технології у тваринництві та дотримуючись
            міжнародних стандартів якості.
          </p>
          <p>
            Підприємство активно впроваджує інновації, зокрема у сфері енергоефективності та
            екологічної відповідальності, зменшуючи вплив на довкілля та підвищуючи економічну
            ефективність виробництва.
          </p>

          <h3 className="text-2xl font-semibold">Енергетичне рішення для тваринництва</h3>
          <p>
            Молочно-товарні комплекси мають високі енергетичні потреби: системи доїння, охолодження,
            освітлення та вентиляції працюють цілодобово. Встановлення сонячної електростанції
            дозволяє «Сігнет-Мілк» скоротити витрати на електроенергію, гарантувати стабільність
            енергопостачання та підтримати стратегію сталого розвитку.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="bg-white text-black p-6 space-y-3">
              ...
              <ul className="list-disc list-inside">
                ...
                <li>Локація: виробничі потужності «Сігнет-Мілк»</li>
                <li>Формат реалізації: повний цикл «під ключ»</li>
              </ul>
            </div>
            <div className="bg-white text-black p-6 space-y-3">
              <h4 className="text-lg font-semibold">Переваги для «Сігнет-Мілк»:</h4>
              <ul className="list-disc list-inside">
                <li>Суттєве зниження витрат на електроенергію</li>
                <li>Стабільність роботи систем доїння та охолодження молока</li>
                <li>Підвищення енергонезалежності підприємства</li>
                <li>Екологічність і скорочення викидів СО₂</li>
                <li>
                  Зміцнення іміджу компанії як сучасного та інноваційного виробника молочної
                  продукції
                </li>
              </ul>
            </div>

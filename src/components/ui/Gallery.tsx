...
export default function Gallery() {
  return (
    <section className="container mx-auto py-6 sm:py-8 md:py-14 lg:py-16 px-6 sm:px-8 lg:px-10 border-t border-gray-600">
      <h2 className="text-center text-2xl md:text-3xl lg:text-4xl mb-9 font-montserrat font-normal">
        ПРОЄКТИ
      </h2>
